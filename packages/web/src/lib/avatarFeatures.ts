...
export const AVATAR_FEATURES: FeatureCategory[] = [
		...
		features: [
			{
				...
				zIndex: 30,
				svgContent: `
					<path class="eyebrow-color" fill="#5D4037" d="M3.982,117.932C3.982,117.932 127.294,94.414 195.942,106.491C195.942,106.491 205.477,64.539 10.974,90.6C10.974,90.6 5.117,97.37 3.982,117.932Z" />
				`
			},
			{
				id: 'eyebrow_straight_bushy',
				name: 'Bushy Straight Brow',
				defaultX: -30,
				defaultY: -30,
				defaultScaleX: 0.225,
				defaultScaleY: 0.225,
				zIndex: 30,
				svgContent: `
					<path class="eyebrow-color" fill="#5D4037" d="M3.592,124.667C3.592,124.667 6.691,94.318 8.642,87.618C9.3,85.357 15.299,84.468 15.299,84.468C9.318,87.458 7.938,117.491 10.127,115C10.127,115 10.85,85.911 21.87,83.176C45.979,77.193 109.706,70.818 156.163,79.793C202.621,88.767 196.094,104.414 196.094,104.414C139.723,99.589 86.525,98.311 3.592,124.667Z" />
				`
			},
			{
				id: 'eyebrow_bushy',
				name: 'Bushy Arched Brow',
				defaultX: -30,
				defaultY: -30,
				defaultScaleX: 0.225,
				defaultScaleY: 0.225,
				zIndex: 30,
				svgContent: `
					<path class="eyebrow-color" fill="#5D4037" d="M11.598,139.797C11.598,139.797 98.472,108.91 129.349,105.711C152.271,103.336 196.86,120.601 196.86,120.601C183.623,98.64 168.192,77.699 134.993,65.023C134.993,65.023 151.173,75.559 150.275,80.069C134.711,63.855 108.134,52.001 5.154,115.65C5.154,115.65 3.039,117.138 3.144,120.781C3.264,124.945 11.598,139.797 11.598,139.797Z" />
				`
			},
			{
				id: 'eyebrow_arched',
	...
	},
	{
		...
		features: [
			{
				id: 'beard_proper_mustache',
				name: 'Proper Mustache',
				defaultX: 0,
				defaultY: 0,
				defaultScaleX: 1,
				defaultScaleY: 1,
				...
				svgContent: `
					<g transform="translate(73, 119)">
						<path class="hair-color" fill="#6f3719" d="M26.87,2.717C28.43,1.159 31.12,-0.372 35.538,0.081C43.955,0.944 44.459,10.513 53.74,4.254C53.74,4.254 52.948,11.304 41.149,11.16C33.657,11.069 29.157,8.836 26.87,7.218C24.583,8.836 20.083,11.069 12.59,11.16C0.791,11.304 0,4.254 0,4.254C9.281,10.513 9.785,0.944 18.202,0.081C22.62,-0.372 25.31,1.159 26.87,2.717Z" />
					</g>
				`
			},
			{
				id: 'beard_shaggy_mustache',
				name: 'Shaggy Mustache',
				defaultX: 0,
				defaultY: 0,
				defaultScaleX: 1,
				defaultScaleY: 1,
				zIndex: 15,
				svgContent: `
					<g transform="translate(75.5, 119.5)">
						<path class="hair-color" fill="#6f3719" d="M24.232,10.699C23.107,10.699 22.474,9.471 20.857,8.608C17.818,6.987 14.667,11.076 12.897,10.608C12.068,10.389 10.299,8.371 8.425,7.883C6.567,7.4 3.74,9.262 0.706,10.469C0.706,10.469 -2.761,8.469 5.67,2.972C12.851,-1.711 21.658,0.405 24.14,0.945C26.622,0.405 35.613,-1.711 42.794,2.972C51.225,8.469 47.758,10.469 47.758,10.469C44.725,9.262 41.897,7.4 40.04,7.883C38.166,8.371 36.397,10.389 35.567,10.608C33.797,11.076 30.646,6.987 27.607,8.608C25.99,9.471 25.357,10.699 24.232,10.699Z" />
					</g>
				`
			},
			{
				...
				svgContent: `
					<g transform="translate(45, 120)">
						<path class="hair-color" fill="#6f3719" d="M28.156,32.293C27.896,43.774 53.781,38.555 53.781,38.555C53.781,38.555 80.929,43.774 80.669,32.293C80.669,32.293 98.621,27.801 94.117,18.084C94.117,18.084 105.059,8.349 99.346,1.674L105.31,1.77C105.31,1.77 114.045,28.211 105.905,34.535C105.905,34.298 106.279,29.17 102.942,29.076C102.942,29.076 107.51,37.76 100.308,44.961C100.308,44.961 100.131,38.736 97.497,39.614C97.497,39.614 100.237,55.692 85.131,60.827L85.454,57.552C86.464,55.329 84.231,67.076 53.92,71.414L53.916,71.414C24.938,70.008 23.372,57.552 23.372,57.552L23.695,60.827C8.589,55.692 11.329,39.614 11.329,39.614C8.694,38.736 9.304,48.109 9.304,48.109C2.103,40.907 5.884,29.076 5.884,29.076C2.547,29.251 3.371,36.109 3.371,36.109C-4.77,29.785 4.393,0 4.393,0L10.71,1.674C4.996,8.349 14.709,18.084 14.709,18.084C10.205,27.801 28.156,32.293 28.156,32.293Z" />
					</g>
				`
			},
			{
				...
				zIndex: 15,
				svgContent: `
					<g transform="translate(46.5, 124)">
						<path class="hair-color" fill="#6f3719" fill-opacity="0.7" d="M52.625,42.499C52.625,42.499 79.2,44.466 79.903,30.133C79.903,30.133 96.625,25.426 92.269,18.084C92.269,18.084 101.513,20.734 98.226,0L103.136,0C103.136,0 108.27,13.737 105.822,20.622L104.523,18.084C104.523,18.084 106.29,23.529 98.226,37.44C98.226,37.44 99.979,33.802 98.433,34.224C98.433,34.224 90.705,60.546 52.625,60.827C14.544,60.546 8.203,33.114 8.203,33.114C7.34,32.181 7.024,34.71 7.024,34.71C-1.041,20.798 2.113,16.804 2.113,16.804L0.833,20.046C-1.615,13.161 2.113,0 2.113,0L7.024,0C3.736,20.734 12.981,18.084 12.981,18.084C8.625,25.426 25.346,30.133 25.346,30.133C26.049,44.466 52.625,42.499 52.625,42.499Z" />
					</g>
				`
			},
			{
				...
				svgContent: `
					<g transform="translate(46.5, 124)">
						<path class="hair-color" fill="#6f3719" d="M1.733,0C1.733,0 -2.843,11.553 2.877,23.907L4.02,21.848C4.02,21.848 6.651,29.686 14.773,31.658L16.489,30.427C16.489,30.427 17.894,33.975 26.975,33.918C35.839,33.863 37.536,30.514 37.536,30.514L39.114,31.658C39.114,31.658 44.285,32.829 48.06,23.335L49.432,25.051C49.432,25.051 57.897,21.619 52.978,0.343L47.593,0.915C47.593,0.915 46.801,9.609 45.314,8.465C46.035,8.015 43.834,16.588 36.781,15.74C36.781,15.74 29.277,21.413 19.211,16.266C18.444,14.623 12.619,17.428 10.197,9.494C10.197,9.494 7.283,6.895 7.283,0.261L1.733,0Z"/>
					</g>
				`
			}
		]
